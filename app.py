...
SETTINGS_KEYS = {'wo_locations', 'wo_salespeople', 'wo_priorities', 'smtp_config', 'turnstile_config', 'branding', 'smtp_notifications_enabled', 'public_url', 'setup_complete', 'display_timezone', 'display_time_format', 'modules_enabled', 'zonechart_config', 'part_locations'}
...
MODULE_KEYS = ('inventory', 'work_orders', 'knowledge_base', 'glossary', 'zone_chart')
_MODULE_DEFAULTS = {'inventory': True, 'work_orders': True, 'knowledge_base': True, 'glossary': True, 'zone_chart': True}
